...
unsigned short VA_GetPanelStatus(plcbit enable, unsigned long VCHandle, unsigned long PanelStatus);
unsigned short VA_ExtractKeyMatrix(plcbit enable, unsigned long VCHandle, unsigned long pKeyMatrix, unsigned long uiKeysToRead, unsigned long puiKeysRead, unsigned long uiTimeoutInMsec, unsigned long puiAgeInMsec);
...
unsigned short VA_TimeSynchronize(plcbit enable, unsigned long VCHandle);
