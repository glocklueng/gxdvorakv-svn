  ...
  45                     ; 19 @far @interrupt void NonHandledInterrupt (void)
  45                     ; 20 {
  46                     	switch	.text
  ...
  98  0028 82            	dc.b	130
 100  0029 00            	dc.b	page(f_CAN_RX_ISR)
 101  002a 0000          	dc.w	f_CAN_RX_ISR
 102  002c 82            	dc.b	130
 104  002d 00            	dc.b	page(f_CAN_TX_ISR)
 105  002e 0000          	dc.w	f_CAN_TX_ISR
 ...
 160  0065 00            	dc.b	page(f_TIM4_UPD_OVF_Interrupt)
 161  0066 0000          	dc.w	f_TIM4_UPD_OVF_Interrupt
 ...
 238                     	xref	f_CAN_RX_ISR
 239                     	xref	f_CAN_TX_ISR
 240                     	xref	f_TIM4_UPD_OVF_Interrupt
 241                     	xref	__stext
 260                     	end
